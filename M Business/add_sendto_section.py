      ...
      <div id="sendToSection" style="display:none;margin-top:6px;">
        <div class="acc-item">
          ...
          <div class="acc-body open">
            ...
            <button onclick="openSendModal()" style="width:100%;padding:10px;background:linear-gradient(135deg, var(--app-accent, var(--app-accent, #00BCD4)),var(--app-accent2, #00BCD4));border:none;border-radius:8px;color:#fff;font-weight:700;font-size:13px;cursor:pointer;font-family:inherit;display:flex;align-items:center;justify-content:center;gap:8px;margin-top:6px;">
