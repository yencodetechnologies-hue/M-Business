...
css_styles = """
        ...
        .form-input:focus { border-color: #00BCD4 !important; background: #FFFFFF; box-shadow: 0 0 0 3px rgba(0,188,212,.08); }
        ...
        .form-select:focus { border-color: #00BCD4 !important; box-shadow: 0 0 0 3px rgba(0,188,212,.08); }
        ...
        .form-textarea:focus { border-color: #00BCD4 !important; box-shadow: 0 0 0 3px rgba(0,188,212,.08); }
        ...
        .template-opt:hover { border-color: #00BCD4; }
        .template-opt.selected { border-color: #00BCD4; background: #F0FDFE; }
        .template-opt-icon { font-size: 20px; margin-bottom: 4px; }
        .template-opt-name { font-size: 10px; font-weight: 700; color: #607D86; }
        .template-opt.selected .template-opt-name { color: #00BCD4; }
        ...
        .item-input:focus { border-color: #00BCD4 !important; background: #FFFFFF; box-shadow: 0 0 0 2px rgba(0,188,212,.08); }
        ...
        .add-item-btn { display: flex; align-items: center; gap: 6px; padding: 8px 14px; background: #F0FDFE; border: 1.5px dashed #00BCD4; border-radius: 9px; font-size: 12px; font-weight: 700; color: #00BCD4; cursor: pointer; transition: all .15s; font-family: inherit; width: 100%; justify-content: center; }
        .add-item-btn:hover { background: #E0F7FA; }
        ...
        .total-row.grand { padding: 10px 14px; background: linear-gradient(135deg, #F0FDFE, #E0F7FA); border-radius: 10px; border: 1.5px solid #E0F7FA; margin-top: 6px; }
        .total-row.grand .total-label { font-size: 14px; font-weight: 800; color: #1A2E35; }
        .total-row.grand .total-val { font-size: 18px; font-weight: 900; color: #00BCD4; }
        ...
        .pt-opt:hover { border-color: #00BCD4; }
        .pt-opt.selected { border-color: #00BCD4; background: #F0FDFE; color: #00BCD4; }
        .pt-opt-days { font-size: 14px; font-weight: 800; color: #1A2E35; }
        .pt-opt.selected .pt-opt-days { color: #00BCD4; }
        .pt-opt-label { font-size: 9px; color: #A0B8BE; font-weight: 600; }
        .pt-opt.selected .pt-opt-label { color: #00BCD4; }
        ...
        .sig-pad:hover { border-color: #00BCD4; background: #F0FDFE; }
"""
