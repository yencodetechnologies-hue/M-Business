...
.left-panel{flex:1;background:linear-gradient(135deg,#0F172A 0%,#1E293B 50%,#1E293B 100%);display:flex;flex-direction:column;justify-content:center;padding:60px;position:relative;overflow:hidden;}
...
.brand-icon i{font-size:22px;color:#FFFFFF;}
.brand-name{font-size:22px;font-weight:900;color:#FFFFFF;}
.brand-name span{color: var(--app-accent, var(--app-accent, #2563EB));}
.panel-title{font-size:36px;font-weight:900;color:#FFFFFF;line-height:1.2;margin-bottom:16px;}
.panel-title span{color:#2563EB;}
...
.right-panel{width:480px;background:#FFFFFF;display:flex;flex-direction:column;justify-content:center;padding:56px 48px;}
.login-title{font-size:24px;font-weight:900;color:#1E293B;margin-bottom:6px;}
.login-sub{font-size:13px;color:#64748B;margin-bottom:32px;}
.form-group{margin-bottom:18px;}
.form-group label{display:block;font-size:11px;font-weight:800;color:#64748B;text-transform:uppercase;letter-spacing:.7px;margin-bottom:7px;}
.inp{width:100%;padding:13px 16px;border:1.5px solid #E2E8F0;border-radius:12px;font-family:"Nunito",sans-serif;font-size:14px;color:#1E293B;background:#F8FAFC;outline:none;transition:all .15s;}
.inp:focus{border-color:#E2E8F0;background:#F8FAFC;box-shadow:none;outline:none;}
.inp-icon-wrap{position:relative;}
.inp-icon-wrap .inp{padding-left:44px;}
.inp-icon{position:absolute;left:14px;top:50%;transform:translateY(-50%);color:#64748B;font-size:18px;}
.login-btn{width:100%;padding:14px;background:linear-gradient(135deg,#2563EB,#2563EB);color:#FFFFFF;border:none;border-radius:12px;font-family:"Nunito",sans-serif;font-size:15px;font-weight:800;cursor:pointer;transition:all .18s;margin-top:8px;display:flex;align-items:center;justify-content:center;gap:8px;}
.login-btn:hover{transform:translateY(-1px);box-shadow:0 8px 24px rgba(37, 99, 235, .35);}
.divider{display:flex;align-items:center;gap:12px;margin:22px 0;color:#64748B;font-size:12px;font-weight:600;}
.divider::before,.divider::after{content:"";flex:1;height:1px;background:#E2E8F0;}
.otp-btn{width:100%;padding:12px;background:transparent;border:1.5px solid #E2E8F0;border-radius:12px;font-family:"Nunito",sans-serif;font-size:14px;font-weight:700;color:#64748B;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;transition:all .15s;}
.otp-btn:hover{border-color:#2563EB;color:#2563EB;background:#EFF6FF;}
.login-footer{margin-top:28px;font-size:12px;color:#64748B;text-align:center;}
.login-footer a{color:#2563EB;font-weight:700;text-decoration:none;}
.secure-badge{display:flex;align-items:center;gap:6px;background:#F8FAFC;border:1px solid #64748B;border-radius:8px;padding:8px 14px;font-size:12px;font-weight:700;color:#1E293B;margin-bottom:24px;}
      `}</style>
      <div className="auditor-login-body">
        <div className="left-panel">
          ...
          <div className="features">
            <div className="feat"><div className="feat-icon" style={{ background: 'rgba(37, 99, 235, .2)' }}><i className="ti ti-file-analytics" style={{ color: '#2563EB' }}></i></div>View full income & expense statements</div>
            ...
            <div className="feat"><div className="feat-icon" style={{ background: 'rgba(22, 163, 74, .2)' }}><i className="ti ti-download" style={{ color: '#16A34A' }}></i></div>Download PDF, Excel & CSV reports</div>
            <div className="feat"><div className="feat-icon" style={{ background: 'rgba(100, 116, 139, .2)' }}><i className="ti ti-message-2" style={{ color: '#64748B' }}></i></div>Add audit notes & flag transactions</div>
          </div>
        </div>
        <div className="right-panel">
          ...
          <div className="form-group">
            ...
            <div className="inp-icon-wrap">
              ...
              <input className="inp" defaultValue="Your Company Pvt Ltd" readOnly style={{ background: '#F8FAFC', color: '#64748B' }} />
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '18px', fontSize: '13px' }}>
            <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer', fontWeight: 600, color: '#64748B' }}><input type="checkbox" style={{ accentColor: '#2563EB' }} /> Remember this device</label>
            <a href="#" style={{ color: '#2563EB', fontWeight: 700, textDecoration: 'none' }}>Forgot password?</a>
          </div>
