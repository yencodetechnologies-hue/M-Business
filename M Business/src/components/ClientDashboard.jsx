...
// // ── Seed Data ──────────────────────────────────────────────────
// const CLIENT_USER = { name:"", email:"", company:"", avatar:"", plan:"" };

// const MY_PROJECTS = [
//   { id:"PRJ001", name:"Website Redesign",   status:"In Progress", progress:65,  deadline:"2024-05-30", budget:"₹2,59,600", spent:"₹1,68,740", manager:"Kiran Dev",  tasks:12, completedTasks:8 },
//   { id:"PRJ002", name:"Mobile App Dev",     status:"Pending",     progress:15,  deadline:"2024-08-15", budget:"₹5,31,000", spent:"₹79,650",   manager:"Meena Raj",  tasks:24, completedTasks:4 },
//   { id:"PRJ003", name:"Brand Identity Kit", status:"Completed",   progress:100, deadline:"2024-03-01", budget:"₹85,000",   spent:"₹82,500",   manager:"Kiran Dev",  tasks:8,  completedTasks:8 },
// ];

// const MY_PAYMENTS = [
//   { id:"INV001", project:"Website Redesign",   date:"2024-04-01", due:"2024-04-30", amount:"₹1,47,500", status:"Paid",    method:"UPI" },
//   { id:"INV002", project:"Mobile App Dev",     date:"2024-05-01", due:"2024-05-15", amount:"₹79,650",   status:"Overdue", method:"—" },
//   { id:"INV003", project:"Brand Identity Kit", date:"2024-03-10", due:"2024-04-10", amount:"₹82,500",   status:"Paid",    method:"Bank Transfer" },
//   { id:"INV004", project:"Website Redesign",   date:"2024-05-10", due:"2024-06-10", amount:"₹1,12,100", status:"Pending", method:"—" },
// ];
...
//           fontSize:18, transition:"all 0.18s", outline:"none",
//         }}
...
//           zIndex:9999,
//           overflow:"hidden",
//           animation:"notif-slide-in 0.22s cubic-bezier(0.34,1.56,0.64,1)",
//         }}>
//           {/* Panel header */}
//           <div style={{
...
//                     animation:`notif-item-in 0.25s ease ${i*0.04}s both`,
//                   }}
...
//                         animation:"pulse-dot-color 1.8s ease infinite",
//                       }}/>
//                     )}
//                   </div>
...
//                       color: n.read ? "#374151" : "#0f172a", lineHeight:1.4,
//                       marginBottom:4,
//                     }}>
//                       {n.text}
//                     </div>
...
//                           onClick={() => {
//                             onMarkRead(n.id);
//                             if(n.actionPage) onNavigate(n.actionPage);
//                             setOpen(false);
//                           }}
//                           style={{
...
// // ── Settings Page ────────────────────────────────────────────
// function SettingsPage({ clientUser }) {
//   const [form,setForm]=useState({ name:clientUser?.name||"", email:clientUser?.email||"", company:clientUser?.company||"", notifications:true, invoiceAlerts:true, weeklyReport:false });
//   const [saved,setSaved]=useState(false);
...
//         return (
//           <div key={n.id} onClick={()=>onMarkRead(n.id)} style={{ background:n.read?"#fff":"#fafafe", borderRadius:12, border:`1px solid ${n.read?"#e2e8f0":"#c7d2fe"}`, padding:"14px 16px", display:"flex", alignItems:"center", gap:12, cursor:"pointer", transition:"background 0.15s" }}
//             onMouseEnter={e=>e.currentTarget.style.background="#f8faff"}
//             onMouseLeave={e=>e.currentTarget.style.background=n.read?"#fff":"#fafafe"}>
...
//         ))}
//       </div>
//       {displayed.map(t=><TaskCard key={t.id} task={t}/>)}
//     </>
//   );
// }
...
//         {/* Desktop top bar */}
//         <div style={{ background:"#fff", borderBottom:"1px solid #f1f5f9", padding:"12px 28px", display:"flex", alignItems:"center", justifyContent:"space-between" }} className="desktop-topbar">
//           <div>
//             <h1 style={{ fontSize:18, fontWeight:800, color:"#0f172a", letterSpacing:-0.5, margin:0 }}>{page.icon} {page.label}</h1>
//             <p style={{ fontSize:12, color:"#94a3b8", marginTop:2 }}>Welcome back, {clientUser.name.split(" ")[0]} 👋</p>
//           </div>
//           {/* Bell in desktop header */}
//           <NotificationBell notifications={notifications} onMarkRead={markRead} onMarkAllRead={markAllRead} onNavigate={navigateTo}/>
//         </div>
