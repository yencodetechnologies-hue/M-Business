...
.kpi.vendor{border-left-color:var(--app-accent);}
...
.modal-footer{display:flex;justify-content:flex-end;gap:10px;margin-top:22px;padding-top:16px;border-top:1px solid var(--border);}
      ...
      <div className="main">
        <div className="topbar">
          <div className="breadcrumb"><i className="ti ti-users" style={{ fontSize: 22, color: '#1E293B' }}></i><span style={{ fontSize: 22, fontWeight: 900, color: '#1E293B' }}>Vendors</span></div>
        ...
        <div className="content">
          <div className="kpi-grid kpi-grid-4">
            <div className="kpi vendor" style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
              <div style={{ width: 40, height: 40, borderRadius: 10, background: 'var(--app-accent-light)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}><i className="ti ti-users" style={{ color: 'var(--app-accent)', fontSize: 18 }}></i></div>
            ...
            <div className="kpi pending" style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
              <div style={{ width: 40, height: 40, borderRadius: 10, background: 'var(--app-accent-light)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}><i className="ti ti-alert-circle" style={{ color: 'var(--app-muted)', fontSize: 18 }}></i></div>
            ...
            <div className="kpi expense" style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
              <div style={{ width: 40, height: 40, borderRadius: 10, background: 'var(--app-accent-light)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}><i className="ti ti-check" style={{ color: 'var(--app-text)', fontSize: 18 }}></i></div>
                      ...
                      return (
                        <tr key={v._id || i}>
                          ...
                          <td><div style={{ display: 'flex', gap: '5px' }}>
                            ...
                            <button className="btn btn-outline btn-sm" style={{ color: 'var(--app-text)', borderColor: '#E2E8F0' }} onClick={() => handleDeleteVendor(v)}><i className="ti ti-trash"></i></button>
                          </div></td>
                        </tr>
                      );
                    })}
