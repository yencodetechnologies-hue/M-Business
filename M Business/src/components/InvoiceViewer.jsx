  ...
  return (
    <div className="print-wrapper" style={{ fontFamily: currentT.fontFamily || "'Plus Jakarta Sans', sans-serif", background: "#f1f5f9", minHeight: "100vh", padding: "20px 12px" }}>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        @media print {
          ...
          .inv-paper { position: absolute !important; top: 0 !important; left: 0 !important; width: 210mm !important; max-width: 210mm !important; margin: 0 !important; border-radius: 0 !important; box-shadow: none !important; display: flex !important; min-height: 297mm !important; }
      ...
      <div className="inv-paper">
        ...
        {/* Bill To */}
        <div className="inv-btgrid" style={{ display: "grid", gridTemplateColumns: inv.project ? "1fr 1fr" : "1fr", borderBottom: currentT.borderStyle || "2px solid #f1f5f9", flexShrink: 0 }}>
          <div style={{ padding: "20px 32px", borderRight: inv.project ? (currentT.borderStyle || "1px solid #f1f5f9") : "none" }}>
          ...
          {inv.project && (
            <div style={{ padding: "20px 32px" }}>
              <div style={{ fontSize: 9, color: "#94a3b8", fontWeight: 700, letterSpacing: 2, marginBottom: 10 }}>PROJECT</div>
            ...
            <tbody>
              {items.map((item, idx) => (
                <tr key={idx} style={{ borderBottom: "1px solid var(--app-border)" }}>
                  <td style={{ padding: "12px 11px", color: "var(--app-muted)", fontWeight: 700, fontSize: 12, opacity: 0.5 }}>{String(idx + 1).padStart(2, "0")}</td>
