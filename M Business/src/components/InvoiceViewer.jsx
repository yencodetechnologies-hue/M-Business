                  ...
                  <div style={{ display: "flex", justifyContent: "flex-end", marginTop: 20 }}>
                    <div style={{ width: "min(280px,100%)" }}>
                      {[
                        ...
                        ...(discountAmt > 0 ? [[`Discount${inv.discountType === "Custom" && inv.customDiscountType ? ` (${inv.customDiscountType})` : inv.discountType === "Custom" ? "" : " (%)"}`, "- " + formatCurrency(discountAmt, inv.currency)]] : []),
