              ...
              <div className="inv-creator-card-body">
                ...
                <div className="inv-creator-form-row">
                  <div className="inv-creator-form-group">
                    ...
                    <input required className="inv-creator-form-input" type="number" value={form.amount || ''} onChange={e => handleInputChange('amount', Number(e.target.value))} placeholder="₹ 0" onWheel={e => e.target.blur()} />
                  </div>
                  <div className="inv-creator-form-group">
                ...
                {(form.amount > 0) && (() => {
                  ...
                  return (
                    <div className="inv-creator-totals-section" style={{marginTop:10}}>
                      <div className="inv-creator-total-row"><span className="inv-creator-total-label">Subtotal</span><span className="inv-creator-total-val">₹{base.toLocaleString()}</span></div>
                      {disc > 0 && <div className="inv-creator-total-row discount"><span className="inv-creator-total-label">Discount</span><span className="inv-creator-total-val">- ₹{Math.round(disc).toLocaleString()}</span></div>}
                      <div className="inv-creator-total-row tax"><span className="inv-creator-total-label">GST / Tax ({taxRate}%)</span><span className="inv-creator-total-val">+ ₹{Math.round(gst).toLocaleString()}</span></div>
                      {extra > 0 && <div className="inv-creator-total-row"><span className="inv-creator-total-label">Extra Charges</span><span className="inv-creator-total-val">+ ₹{extra.toLocaleString()}</span></div>}
                      <div className="inv-creator-total-row grand"><span className="inv-creator-total-label">Total Amount</span><span className="inv-creator-total-val">₹{Math.round(grandTotal).toLocaleString()}</span></div>
                    </div>
                  );
                })()}
              </div>
              ...
              <div className="inv-creator-card-body">
                <div className="inv-creator-form-row">
                  ...
                  <div className="inv-creator-form-group">
                    ...
                    <select className="inv-creator-form-select" value={form.currency || '₹'} onChange={e => handleInputChange('currency', e.target.value)}>
