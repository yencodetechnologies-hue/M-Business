    ...
    <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: "#F8FAFC", minHeight: "100vh", padding: "40px 20px" }}>
      <style>{`
        ...
        @media print {
          ...
          .receipt-paper { box-shadow: none !important; border: 1px solid #E2E8F0 !important; margin: 0 !important; width: 100% !important; }
        }
      `}</style>

      <div className="no-print" style={{ display: "flex", gap: 12, justifyContent: "center", marginBottom: 30 }}>
        <button onClick={() => window.print()} style={{ padding: "12px 28px", background: "linear-gradient(135deg,#2563EB,#2563EB)", border: "none", borderRadius: 12, fontWeight: 700, fontSize: 14, cursor: "pointer", color: "#FFFFFF", fontFamily: "inherit", boxShadow: "0 4px 12px rgba(37, 99, 235, 0.3)" }}>Print Receipt</button>
      </div>

      <div className="receipt-paper" style={{ maxWidth: 500, margin: "0 auto", background: "#FFFFFF", borderRadius: 24, boxShadow: "0 20px 50px rgba(0,0,0,0.05)", overflow: "hidden", border: "1px solid #E2E8F0" }}>
        {/* Header */}
        <div style={{ background: "linear-gradient(135deg,#2563EB,#2563EB)", padding: "40px 32px", textAlign: "center", color: "#FFFFFF" }}>
          {invData.logo && (
        ...
        <div style={{ padding: "32px" }}>
          <div style={{ textAlign: "center", marginBottom: 32 }}>
            ...
            <div style={{ fontSize: 12, color: "#2563EB", fontWeight: 700, marginTop: 4, textTransform: "uppercase", letterSpacing: 1 }}>Amount Received</div>
          </div>
          ...
          <div style={{ marginTop: 40, textAlign: "center", background: "#F8FAFC", borderRadius: 16, padding: "20px" }}>
            <div style={{ fontSize: 14, color: "#2563EB", fontWeight: 800 }}>THANK YOU!</div>
            <div style={{ fontSize: 12, color: "#2563EB", marginTop: 4 }}>We appreciate your business.</div>
          </div>
        ...
        <div style={{ background: "#F8FAFC", padding: "16px", textAlign: "center", borderTop: "1px solid #E2E8F0" }}>
          <div style={{ fontSize: 10, color: "#64748B", fontWeight: 700, letterSpacing: 1 }}>COMPUTER GENERATED RECEIPT</div>
        </div>
      </div>
    </div>
  );
