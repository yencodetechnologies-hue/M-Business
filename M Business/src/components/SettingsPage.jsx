...
.sn-item.sn-active{background:rgba(var(--app-accent-rgb,0,188,212),.12);color:var(--app-accent,#00BCD4)}
.sn-item i{font-size:16px;flex-shrink:0;color:var(--app-muted,#607D86)}
.sn-item.sn-active i,.sn-item:hover i{color:var(--app-accent,#00BCD4)}
...
.form-input:focus{border-color:var(--app-accent,#00BCD4);background:#fff;box-shadow:0 0 0 3px rgba(var(--app-accent-rgb,0,188,212),.08)}
...
.form-select:focus{border-color:var(--app-accent,#00BCD4)}
...
.form-textarea:focus{border-color:var(--app-accent,#00BCD4);background:#fff;box-shadow:0 0 0 3px rgba(var(--app-accent-rgb,0,188,212),.08)}
...
.avatar-big{width:72px;height:72px;border-radius:50%;background:linear-gradient(135deg,var(--app-accent,#00BCD4),#006E7F);display:flex;align-items:center;justify-content:center;font-size:26px;font-weight:800;color:#fff;flex-shrink:0;border:3px solid rgba(var(--app-accent-rgb,0,188,212),.2);position:relative}
.avatar-edit{position:absolute;bottom:0;right:0;width:22px;height:22px;border-radius:50%;background:var(--app-accent,#00BCD4);border:2px solid #fff;display:flex;align-items:center;justify-content:center;font-size:11px;color:#fff;cursor:pointer}
.avatar-upload-btn{display:flex;align-items:center;gap:6px;padding:8px 16px;background:rgba(var(--app-accent-rgb,0,188,212),.1);border:1.5px solid var(--app-accent,#00BCD4);border-radius:9px;font-size:12px;font-weight:700;color:var(--app-accent,#00BCD4);cursor:pointer;font-family:inherit;transition:all .15s}
.avatar-upload-btn:hover{background:var(--app-accent,#00BCD4);color:#fff}
...
.logo-upload-area:hover{border-color:var(--app-accent,#00BCD4);background:rgba(var(--app-accent-rgb,0,188,212),.04)}
...
.toggle.t-on{background:var(--app-accent,#00BCD4)}
...
.sec-save-btn{display:flex;align-items:center;gap:6px;padding:10px 22px;background:var(--app-accent,#00BCD4);color:#fff;border:none;border-radius:10px;font-size:13px;font-weight:700;cursor:pointer;font-family:inherit;transition:background .15s;box-shadow:0 3px 10px rgba(var(--app-accent-rgb,0,188,212),.25)}
...
export default function SettingsPage({ user, appTheme, setAppTheme, themes, customColor, setCustomColor, onLogoChange, triggerCrop, onProfileUpdate, THEME }) {
  ...
  const accent = `var(--app-accent, #00BCD4)`;
                ...
                <div className="form-group">
                  ...
                  <div className="color-picker-row">
                    ...
                    <div style={{ position: 'relative' }}>
                      ...
                      />
                      <input id="customColorPicker" type="color" value={customColor || '#00BCD4'} onChange={e => { setCustomColor(e.target.value); setAppTheme('custom'); }} style={{ position: 'absolute', opacity: 0, width: 0, height: 0 }} />
                    </div>
                  </div>
