  ...
  return (
    <div style={{ width: 340, flexShrink: 0, background: "#fff", borderLeft: `1.5px solid ${P.border}`, display: "flex", flexDirection: "column", height: "100%", overflow: "hidden" }}>
      ...
      <div style={{ flex: 1, overflow: "auto", padding: 16, display: "flex", flexDirection: "column", gap: 13 }}>
        <div>
          <div style={{ fontSize: 10, color: P.muted, fontWeight: 700, letterSpacing: 0.8, marginBottom: 5, textTransform: "uppercase" }}>Title</div>
          <input key={task.title} defaultValue={task.title || ""} onBlur={e => { if (e.target.value.trim() !== String(task.title || "")) onField(id, "title", e.target.value.trim()); }} style={inp} />
        </div>
