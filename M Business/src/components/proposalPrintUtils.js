...
.ps-lbl{font-size:9px;font-weight:700;color:#00BCD4;text-transform:uppercase;letter-spacing:.8px;margin-bottom:8px;display:flex;align-items:center;gap:5px}
...
.pb-lbl{font-size:8px;font-weight:700;color:#00BCD4;text-transform:uppercase;letter-spacing:.7px;margin-bottom:3px}
...
.exec-block.solution{border-left-color:#00BCD4;background:#F0FDFE}
...
.exec-block.solution .eb-lbl{color:#00BCD4}
...
.del-item-p::before{content:'✓';color:#00BCD4;font-weight:800;font-size:11px;flex-shrink:0}
...
.tl-dot{width:20px;height:20px;border-radius:50%;background:#00BCD4;display:flex;align-items:center;justify-content:center;font-size:8px;font-weight:800;color:#fff;flex-shrink:0}
.tl-line-p{width:2px;background:#E0F7FA;flex:1;margin:2px 0;min-height:10px}
.tl-pi:last-child .tl-line-p{display:none}
.tl-pi-title{font-size:10px;font-weight:700;color:#1A2E35}
.tl-pi-date{font-size:9px;color:#00BCD4;font-weight:600}
...
.pricing-tbl thead tr{background:linear-gradient(135deg,#00BCD4,#006E7F)}
...
.pricing-grand{display:flex;justify-content:space-between;padding:6px 8px;background:linear-gradient(135deg,#00BCD4,#006E7F);border-radius:6px;margin-top:5px}
...
.cs-p{padding:8px 10px;background:#F8FAFB;border-radius:8px;border-left:3px solid #00BCD4;margin-bottom:7px}
...
.tm-p{padding:8px 10px;background:#F0FDFE;border-radius:8px;border:1px solid #E0F7FA;margin-bottom:7px;font-style:italic}
.tm-p:last-child{margin-bottom:0}
.tm-p-text{font-size:10px;color:#607D86;margin-bottom:5px}
.tm-p-author{font-size:9px;font-weight:700;color:#00BCD4}
...
const PRINT_BASE_CSS = `
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .del-item-p::before { color:#00BCD4 !important; content:'✓' !important; }
...
function getTheme(name) {
  return THEMES.find(x => x.name === name) || { p: "#00BCD4", g: "linear-gradient(135deg,#00BCD4,#006E7F)" };
}
